...
function numPointsScored(playerName){
    ...
    return game.home.players["Mason Plumlee"].ponts
...
function shoeSize(playerName){
    const game = gameObject()
    return game.away.players["Ben Gordon"].shoe
}

//console.log(shoeSize())

function teamColors(colors){
    const game = gameObject()
...
function playerNumbers(playerName){
    const game = gameObject()
    return game.away.players["Brendan Haywood"].number
